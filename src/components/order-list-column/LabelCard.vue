<template>
  <div class="card p-1">
    ...
    <div class="align-items-center d-flex text-nowrap">
      <a target="_blank" rel="noopener noreferrer" :href="label.track_link" v-text="label.barcode" />
      <a class="btn btn-link" @click="() => print(label)">
        <MaterialIcon icon="print" />
      </a>
      <a class="btn btn-link" @click="() => refresh(label)">
