...
import {type InputHTMLAttributes, type SelectHTMLAttributes, type TextareaHTMLAttributes} from 'vue';
import {type FormBuilder} from '@myparcel-pdk/frontend-form-builder';
...
export namespace Plugin {
  ...
  export type Field = {
    $attributes?: InputHTMLAttributes | SelectHTMLAttributes | TextareaHTMLAttributes | Record<string, unknown>;
