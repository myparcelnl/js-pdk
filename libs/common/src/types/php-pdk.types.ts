...
import {type SupportedDeliveryTypeName, type SupportedPackageTypeName} from '@myparcel-dev/delivery-options';
...
import {type CarrierCollection, type CarrierModel} from './carrier.types';
