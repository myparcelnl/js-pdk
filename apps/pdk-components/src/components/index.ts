...
import DefaultPdkDropdownButtonItem from './DefaultPdkDropdownButtonItem.vue';
...
export const defaultComponents: ComponentMap = {
  ...
  PdkDropdownButtonItem: DefaultPdkDropdownButtonItem,
